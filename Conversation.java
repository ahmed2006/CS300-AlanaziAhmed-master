 ...
 * It works by keeping a HashMap of replies where each reply contains the NPC's part of the conversation
 * and the choices of responses by the Player.
 * The conversation ends when the Player enters an invalid choice and the NPC gets confused, 
 * or the conversation comes to an end with a reply from the NPC containing sign-off text.
 * @author ahmed 
 * @version 2018-04-03
 */
public class Conversation {
     ...
     * Each reply should either contain the sign-off text (to end the conversation), 
     * or provide multiple-choice responses for the Player (this is a simple conversation scenario and one we can do easily).
