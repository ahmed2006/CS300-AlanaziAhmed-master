...
/**
 * This class is part of the " " application. "The Ghost Game" is a very
...
public class Command {
     ...
     * @param firstWord The first word of the command. Null if the command was
     * not recognized.
     * @param rest The rest of the command.
     */
     ...
     *
     * @param index The index of word in the command that is being requested.
     *
